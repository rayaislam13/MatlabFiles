%% This code analyzes data collected by a machine that collects tension in a rod
% It extracts data from a matrix of data and compares the force and strain
% on the rod. It then analyzes the young's modulus and yield stress and
% compares the theoretical values to the experimental
%%
