%% This code for a lab for and Engineering Dynamics course compares different 
%independent values for cylinders of varying sizes rolling down an 
%incline of changing heights

%% constant incline alpha=2.37, hollow cylinder, diamter changing
close all
...
%% constant incline alpha=2.37, hollow cylinder vs. solid cylinder
