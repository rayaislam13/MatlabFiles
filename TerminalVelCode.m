%% This code for a lab in an Engineering Dynamics course takes data collected
% that calculates the terminal velocity of magnets of varying diameters 
% falling down a copper tube and compares the theoretical vs.experimental
% values
