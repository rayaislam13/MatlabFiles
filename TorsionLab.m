%% This code analyses data collected by a machine that measures torsion. 
%It calculates the sheer strain and compares it to the torque
%and calculates yield torques using a polyfit and finds max values
